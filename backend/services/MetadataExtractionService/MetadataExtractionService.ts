...
export const UnimplementedMetadataExtractionService: Layer.Layer<MetadataExtractionService> =
	Layer.succeed(MetadataExtractionService, {
		extractAudioMetadata: (_args) =>
			Effect.dieMessage("MetadataExtractionService.extractAudioMetadata not implemented"),
	})

export const MusicMetadataExtractionService = Layer.succeed(MetadataExtractionService, {
	extractAudioMetadata: ({ name, content, contentType }) =>
		Effect.gen(function* () {
			...
			return {
				...
				trackNumber: typeof metadata.common.track.no === "number" ? metadata.common.track.no : null,
				trackTotal: typeof metadata.common.track.of === "number" ? metadata.common.track.of : null,
				diskNumber: typeof metadata.common.disk.no === "number" ? metadata.common.disk.no : null,
				diskTotal: typeof metadata.common.disk.of === "number" ? metadata.common.disk.of : null,
				coverArt:
