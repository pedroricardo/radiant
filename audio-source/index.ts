...
export namespace AudioSource {
	export class AudioSourceConfigurationError extends Data.TaggedError("AudioSource/ConfigurationError")<{
	...
	const resampleInterleavedFrame = (frame: Float32Array, ratio: number, channels: number): Float32Array => {
		if (channels <= 0) {
			return new Float32Array(0)
		}
